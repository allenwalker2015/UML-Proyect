...
public class Administrador extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!txtContra.equals("")){
            if(txtContra.equals("pofepoo")){
                JOptionPane.showMessageDialog(rootPane, "¡¡Contraseña correcta!!\n ¡Bienvenido!","Correcto",1);
                    setVisible(false);
                    Cambiar_verificar cv = new Cambiar_verificar();
                    cv.setVisible(true);
            }else{
                JOptionPane.showMessageDialog(rootPane, "¡¡Contraseña incorrecta!!\n Vuelva a intentarlo","Incorrecta",2);
            }   
        }else{
            JOptionPane.showMessageDialog(rootPane, "El campo esta vacio","Campo vacio",3);
        }
